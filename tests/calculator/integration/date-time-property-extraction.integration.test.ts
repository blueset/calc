...
(14:30 to hour) + (14:30 to minute)`);
    ...
    it("should handle ambiguity of property extraction and unit conversion", () => {
      const result = calculator.calculate(`12:35 in minute
12:35 + 1 hour in minute
100 hour in minute
100 hour + 1 hour in minute
tomorrow - now in minute
100 hour in min
100 hour + 1 hour in min
tomorrow - now in min`);
    ...
    it("should handle ambiguity of property extraction and unit conversion with variables", () => {
      const result = calculator.calculate(`time = 12:30
dur = 12.59 GiB / 100 Mbps
time in minute
dur in minute`);
