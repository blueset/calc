...
export const editorTheme = EditorView.theme({
  ...
  ".cm-selectionBackground": { backgroundColor: "var(--ed-selection)" },
...
const highlightStyle = HighlightStyle.define([
  ...
  },
  {
    tag: tags.heading6,
    fontWeight: "100",
    color: "var(--ed-heading6)",
    textDecoration: "underline",
    textDecorationColor: "var(--ed-heading6-line)",
    textUnderlineOffset: "15%",
    textDecorationThickness: "2%",
  },
  { tag: tags.comment, color: "var(--ed-comment)", fontStyle: "italic" },
  { tag: tags.number, color: "var(--ed-red)" },
  { tag: tags.keyword, color: "var(--ed-teal)" },
  { tag: tags.operator, color: "var(--ed-gray)" },
  { tag: tags.variableName, color: "var(--ed-blue)" },
  { tag: tags.bracket, color: "var(--ed-bracket)" },
  { tag: tags.constant(tags.variableName), color: "var(--ed-red)" },
  { tag: tags.function(tags.variableName), color: "var(--ed-orange)" },
  { tag: tags.unit, color: "var(--ed-purple)" },
  { tag: tags.bool, color: "var(--ed-red)" },
  { tag: tags.special(tags.string), color: "var(--ed-green)" },
  { tag: tags.definition(tags.variableName), color: "var(--ed-blue)" },
  // Markdown inline styles
  { tag: tags.emphasis, fontStyle: "italic" },
  { tag: tags.strong, fontWeight: "bold" },
  { tag: tags.link, color: "var(--ed-blue)", textDecoration: "underline" },
  {
    tag: tags.url,
    color: "var(--ed-blue)",
