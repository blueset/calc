...
declare let kw_if: any;
declare let kw_then: any;
declare let kw_else: any;
declare let kw_to: any;
declare let kw_as: any;
declare let kw_in: any;
declare let arrow: any;
declare let kw_value: any;
declare let kw_binary: any;
declare let kw_octal: any;
declare let kw_decimal: any;
declare let kw_hexadecimal: any;
declare let decimalDigits: any;
declare let sigFigs: any;
declare let kw_decimals: any;
declare let kw_base: any;
declare let kw_scientific: any;
declare let kw_fraction: any;
declare let kw_percentage: any;
declare let percent: any;
declare let ISO8601: any;
declare let RFC9557: any;
declare let RFC2822: any;
declare let kw_unix: any;
declare let identifier: any;
declare let dayOfYear: any;
declare let weekOfYear: any;
declare let or: any;
declare let and: any;
declare let pipe: any;
declare let kw_xor: any;
declare let ampersand: any;
declare let lessThan: any;
declare let lessThanOrEqual: any;
declare let greaterThan: any;
declare let greaterThanOrEqual: any;
declare let equals: any;
declare let notEquals: any;
declare let lShift: any;
declare let rShift: any;
declare let plus: any;
declare let minus: any;
declare let times: any;
declare let slash: any;
declare let divide: any;
declare let kw_per: any;
declare let kw_mod: any;
declare let bang: any;
declare let tilde: any;
declare let caret: any;
declare let superscript: any;
declare let kw_true: any;
declare let kw_false: any;
declare let constantSymbol: any;
declare let currencySymbolAdjacent: any;
declare let comma: any;
declare let kw_square: any;
declare let kw_squared: any;
declare let kw_cubic: any;
declare let kw_cubed: any;
declare let degree: any;
declare let prime: any;
declare let doublePrime: any;
declare let hexNumber: any;
declare let binaryNumber: any;
declare let octalNumber: any;
declare let dot: any;
declare let permille: any;
declare let scienceExponential: any;
declare let kw_now: any;
declare let kw_today: any;
declare let kw_yesterday: any;
declare let kw_tomorrow: any;
declare let kw_ago: any;
declare let kw_from: any;
declare let plainTime: any;
declare let ws: any;
