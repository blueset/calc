...
const highlightStyle = HighlightStyle.define([
  ...
  { tag: tags.number, color: "var(--ed-purple)" },
  { tag: tags.keyword, color: "var(--ed-pink)" },
  { tag: tags.operator, color: "var(--ed-pink)" },
  { tag: tags.variableName, color: "var(--ed-orange)" },
  { tag: tags.bracket, color: "var(--ed-bracket)" },
  { tag: tags.constant(tags.variableName), color: "var(--ed-purple)" },
  { tag: tags.function(tags.variableName), color: "var(--ed-green)" },
  { tag: tags.unit, color: "var(--ed-cyan)" },
  { tag: tags.bool, color: "var(--ed-purple)" },
  { tag: tags.special(tags.string), color: "var(--ed-yellow)" },
  { tag: tags.definition(tags.variableName), color: "var(--ed-orange)" },
